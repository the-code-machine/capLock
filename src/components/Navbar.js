...
const Navbar = () => {
    ...
    return (
        <>
            <header className={`fixed w-full z-50 transition-all duration-300 shadow-md ${scrolled ? "bg-white shadow-md py-3" : "bg-white/90 backdrop-blur-md py-4"}`}>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <nav className="hidden lg:flex items-center space-x-8">
                            <Link href="/products" passHref>
                                <motion.div
                                    whileHover={{ y: -2 }}
                                    className={`font-medium relative ${router.pathname === "/products" ? "text-black" : "text-gray-600 hover:text-black"}`}
                                >
                                    Products
                            ...
                            <Link href="/about" passHref>
                                <motion.div
                                    whileHover={{ y: -2 }}
                                    className={`font-medium relative ${router.pathname === "/about" ? "text-black" : "text-gray-600 hover:text-black"}`}
                                >
                                    About
                            ...
                            <Link href="/contact" passHref>
                                <motion.div
                                    whileHover={{ y: -2 }}
                                    className={`font-medium relative ${router.pathname === "/contact" ? "text-black" : "text-gray-600 hover:text-black"}`}
                                >
                                    Contact
                            ...
                            <Link href="/faq" passHref>
                                <motion.div
                                    whileHover={{ y: -2 }}
                                    className={`font-medium relative ${router.pathname === "/faq" ? "text-black" : "text-gray-600 hover:text-black"}`}
                                >
                                    FAQ
                                    {router.pathname === "/faq" && (
                                        <motion.div
