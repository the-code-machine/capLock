        ...
        <section className="bg-black text-white py-16">
            <div className="container mx-auto px-6 lg:px-16">
                ...
                <p className="text-center text-gray-300 text-lg mb-8">
                    We participated in an exhibition conducted by AICTE & IDEA Lab on <strong>7th March</strong> at <strong>AICTE Headquarter, Delhi</strong>, where we showcased our latest innovations in 3D printing and IoT solutions.
                </p>
                        ...
                        <SwiperSlide key={index}>
                            ...
                            >
                                ...
                                <div className="p-6 overflow-hidden">
                                    <h3 className="text-xl font-bold text-white w-full truncate">{activity.title}</h3>
                                    <p className="text-gray-400 text-sm mt-2 w-full truncate">{activity.date} | {activity.location}</p>
                                </div>
                            </motion.div>
                        </SwiperSlide>
                    ))}
