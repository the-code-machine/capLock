                ...
                <div className="mt-12 flex flex-col md:flex-row items-center gap-12">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-300 mt-4">
                            With a passionate team and a commitment to excellence, CapLock empowers creators and businesses
                            to transform their ideas into reality, all while maintaining a bold, minimalist style.
                        </p>
